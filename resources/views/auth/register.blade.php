    ...
    <div class="container-fluid">
        ...
        <div class="user" id="user">
            ...
            <div class="user__header">
                <br> &nbsp;<h2 class="alert-danger newfriends breadcumb">STAFF VERIFICATION</h2>
                <form action="{{ route('register') }}" class="form" style="text-align: center;" method="POST"
                      enctype="multipart/form-data">
                    {{csrf_field()}}
                    <div class="form__group">
                        {{--<label for="name">ชื่อ</label>--}}
                        <input type="text" name="name" placeholder="Username" class="form__input" required
                               value="{{old('name')}}" style="text-align: center;"/>
                        <input type="text" name="email" placeholder="Email" class="form__input" required
                               value="{{old('email')}}" style="text-align: center;"/>
                        <input type="password" name="password" placeholder="Password (Minimum 6)" class="form__input" required
                               value="{{old('password')}}" style="text-align: center;"/>
                        <input type="password" name="password_confirmation" placeholder="Password Confirmation" class="form__input" required
                               value="{{old('password_confirmation')}}" style="text-align: center;"/>
