                    ...
                    <div class="row">
                        <div class="col-md-12" style="text-align:left; overflow-y:visible;">
                            ...
                            <p style="overflow: auto; height:300px;">English Please Scroll down<br><br>เงื่อนไขการกรอกฟอร์ม
                                ...
                                เข้าสู่ระบบได้
                                ทางผู้เก็บข้อมูลจะขอสงวนสิทธิ์ข้อมูลไว้เพื่อความปลอดภัยและประโยชน์ของตัวนักศึกษาเองอย่างสูงสุดโดยถูกต้องตามกฏหมาย
                                โดยระบบมีการเข้ารหัสเพื่อรองรับความปลอดภัยของข้อมูลเป็นที่เรียบร้อย
                                <br> <br>
                                "นักศึกษาไทยกรุณากรอกข้อมูลด้วยภาษาไทย"<br><br>หากข้อมูลส่วนใดที่ท่านไม่มีกรุณาใส่ ขีด/dash
                                ด้วยสัญลักษณ์ -
                                <br>เนื่องจากบริเวณภายในงานมีพื้นที่จำกัดจึงขอสงวนสิทธิ์ให้ผู้ที่ลงทะเบียน "และมาถึงก่อน" ได้เข้าร่วมงานก่อน รีบมากันเร็วๆนะครับ :)
                                <br>หากมีปัญหากรุณาติดต่อ P'Staff
                                <br>
