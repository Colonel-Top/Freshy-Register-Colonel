            ...
            <div class="user__header">
                ...
                <form action="{{ route('search-lost-query') }}" class="form" style="text-align: center;" method="POST"
                    ...
                    <div class="form__group">
                        ...
                        <input type="text" name="namesearch" placeholder="Name/ชื่อ" class="form__input" required
                               value="{{old('namesearch')}}" style="text-align: center;"/>
                        <input type="text" name="surnamesearch" placeholder="Surname/นามสกุล" class="form__input" required
                               value="{{old('surnamesearch')}}" style="text-align: center;"/>
                    </div>
