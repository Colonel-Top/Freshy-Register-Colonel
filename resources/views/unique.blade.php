    ...
    <div class="container-fluid">
        ...
        <div class="user">
            ...
            <div class="user__header">
                ...
                <br>
                <h2 class="alert-info breadcrumb" style="font-family: Kanit-Medium; font-size:13px;">
                   ระบบแสดงข้อมูล</h2>
            </div>

            <form action="none" class="form" style="text-align: center;" method="POST"
                ...
                <div class="form__group">
                    ...
                    <input type="text" name="name" placeholder="*ชื่อ" class="form__input" readonly disabled
                           value="{{$data2->name}}"/>
                </div>
                <div class="form__group">
                    {{--<label for="name">ชื่อ</label>--}}
                    <input type="text" name="surname" placeholder="*นามสกุล" class="form__input" readonly disabled
                           value="{{$data2->surname}}"/>
                </div>

                <div class="form__group">
                    {{--<label for="name">ชื่อ</label>--}}
                    <input type="text" name="nickname" placeholder="*ชื่อเล่น" class="form__input" readonly disabled
                           value="{{$data2->nickname}}"/>
                </div>

                <div class="form__group">
                    {{--<label for="name">ชื่อ</label>--}}
                    <input type="text" name="cardid" placeholder="*เลขบัตรประชาชน / PassportID" class="form__input" readonly disabled
                           value="{{$data2->cardid}}"/>
                </div>
                <div class="form__group">
                    {{--<label for="name">ชื่อ</label>--}}
                ...
                <div class="form__group">
                    ...
                    <select class="form__input" id="faculty" name="faculty"  disabled readonly default="{{old('faculty')}}">
                ...
                <div class="form__group">
                    ...
                    <input type="text" name="telephone" placeholder="*เบอร์โทรศัพท์ (ถ้าไม่มีให้ใส่ขีด / - )"
                           class="form__input" readonly disabled value="{{$data2->telephone}}"/>
                </div>
                <div class="form__group">
                    {{--<label for="name">ชื่อ</label>--}}
                ...
                <div class="form__group">
                    ...
                    <input type="text" name="facebook" placeholder="Facebook" class="form__input"
                           value="{{$data2->facebook}}" readonly/>
                </div>
                <div class="form__group">
                    {{--<label for="name">ชื่อ</label>--}}

                    <select class="form__input" name="religion" id="religion"  disabled readonly>
                ...
                <div class="form__group">
                    ...
                    <input type="text" name="disfood" placeholder="*อาหารที่แพ้ (ถ้าไม่มีให้ใส่ขีด / - )"
                           class="form__input" readonly disabled value="{{$data2->disfood}}"/>
                </div>
                <div class="form__group" style="text-align: left">
                    {{--<label for="name">ชื่อ</label>--}}
                    <row>

                        <input type="checkbox" name="vegetarian" value="1" {{($data2->vegetarian) ? " checked" : ""}}  disabled readonly/> มังสวิรัติ<br>
                        <input type="checkbox" name="islamic" value="1"  {{($data2->islamic) ? " checked" : ""}}  disabled readonly/> อาหารอิสลาม<br>
                    </row>
                </div>
